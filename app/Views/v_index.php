...
<div class="container" style="margin-top: 50px;">
    ...
    <h4 class="text-center">CRUD Codeigniter 4 dengan Firebase + Bootstrap</h4><br>
    ...
    <div class="card card-default">
        <div class="card-body">
            <form id="addStudent" class="form-inline" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group mb-2">
                    <label for="age" class="sr-only">Image</label>
                    <input type="file" id="fileButton" class="form-control"  value="upload"/>
...
<script>
    ...
    // Get Data
    firebase.database().ref('test-tafta/').on('value', function (snapshot) {
        ...
        $.each(value, function (index, value) {
            if (value) {
                ...
                <td>' + value.name + '</td>\
                <td>' + value.age + '</td>\
                <td><img src="https://firebasestorage.googleapis.com/v0/b/sahabat-1b809.appspot.com/o/images%2F' + value.pic + '?alt=media&token=c117efd6-0c0a-47c4-b33c-2b9560b87fed" width="200px"></td>\
    ...
    $('#submitStudent').on('click', function () {
        ...
        var userID      = lastIndex + 1;
          ...
          var task = storageRef.putString(output, 'data_url');
        ...
        firebase.database().ref('test-tafta/' + userID).set({
            nis: nis,
            name: name,
            age: age,
            pic: imageName
    ...
    $('body').on('click', '.updateStudent', function () {
        ...
        firebase.database().ref('test-tafta/' + updateID).on('value', function (snapshot) {
    ...
    $('.updateStudent').on('click', function () {
        ...
        var updates = {};
        updates['/test-tafta/' + updateID] = postData;
    ...
    $('.deleteStudent').on('click', function () {
        ...
        firebase.database().ref('test-tafta/' + id).remove();
